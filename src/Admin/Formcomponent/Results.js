          ...
          <div className="col-md-12">
            <div className="result-go">
              <h3>
                ...
                below and see if you can fix the negative scores as per the The
                Takeoff Point pivot framework and re-evaluate it.
              </h3>
              {review}
              <p>
                Review the summary below and see if you can fix the negative
                scores as per <br />
                the The Takeoff Point pivot framework and evaluate again.
              </p>
            </div>
          </div>
        </div>
